...
- A resource must be >0 in TRACKER STATE 0 (Current) to be eligible for a choice.
...
export function buildCyoaPrompt(config = {}) {
    ...
    reqLines.push('- A resource must be >0 in TRACKER STATE 0 (Current) to be eligible for a choice.');
